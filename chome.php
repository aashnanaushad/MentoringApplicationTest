	...
	<nav class=" flex items-center justify-between flex-wrap bg-white p-6">
		<div class="flex items-center flex-shrink-0 text-blue-600 mr-6 ">
			...
			<div class=" w-full block flex-grow lg:flex lg:items-center lg:w-auto">
				...
				<a href="active_chats.php" class="block mt-4 lg:inline-block lg:mt-0 text-blue-600 hover:text-blue-200 mr-4">
					Active Chats
				</a>
			...
			<div class=" px-3 py-10 pt-20 bg-blue-400 flex justify-center">
				...
				<div class="w-full xl:w-3/5 py-6 overflow-y-hidden">
					...
					<div class="flex items-center justify-between">
						<a href="cedit.php"><button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-2 rounded focus:outline-none focus:shadow-outline" >
							Edit Profile
						</button></a>
					</div>
				</div>
