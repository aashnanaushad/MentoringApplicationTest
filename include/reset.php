...
require '../vendor/autoload.php';
 ...
 if(isset($_POST["reset-request"])){
    ...
    $mail->Body    = '<p>Sorry to hear you have trouble logging in.<br> Here is your password reset link:<a href="'.$url.'"><button style="background-color:blue;color:white;width:40px;text-align:center">click<\button></a> Here to Reset Password!</p>';
    $mail->send();
