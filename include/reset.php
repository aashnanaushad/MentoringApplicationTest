...
require '../vendor/autoload.php';
 ...
 if(isset($_POST["reset-request"])){
    ...
    $mail->Body    = '<p>Sorry to hear you have trouble logging in.<br> Here is your password reset link:<a clicktracking=off href='.$url.'>SomeName.com </a> Here to Reset Password!</p>';
    $mail->send();
