...
class Common
{
  ...
  {
      $mainQuery = "INSERT INTO  student SET name='$name',username='$username',email='$email',dept='$department',address='$address',dateofbirth='str_to_date('$dateofbirth','%d.%m.%Y'),phone_no='$phone_no',gender='$gender',father='$father',focc='$focc',mother='$mother',mocc='$mocc',
