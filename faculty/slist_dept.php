...
<!--here showing results in the table -->  
    ...
    <!-- <form action="slist_dept.php" method="post">
    <a href="slist_dept.php"><button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline float-right" type="submit" name="back">
								back
		</button> </a>
        </form> -->
        <?php
