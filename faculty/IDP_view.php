...
<div class=" px-3 py-10 pt-20 bg-blue-400 flex justify-center">
				<div class="lg:flex bg-white shadow-md rounded px-64 pt-8 pb-10 mb-8 " >
				 <div class="w-full  px-32 py-6 overflow-y-hidden"> 
					<div class="mb-4">
    ...
    <div class=" w-full">
            ...
            <tr>
                <td class="w-1/2 text-left py-3 px-4">Test 1</td>
       			<td class="w-1/2 text-left py-3 px-4">80</td>
      		</tr>
      		<tr class="bg-gray-100">
              <td class="w-1/2 text-left py-3 px-4">Test 2</td>
       			<td class="text-left py-3 px-4">70</td>
      		</tr>
			<tr>
            <td class="w-1/2 text-left py-3 px-4">Test 3</td>
       			<td class="w-1/2 text-left py-3 px-4">-</td>
      		</tr>
			<tr class="bg-gray-100">
            ...
            <td class="w-1/2 text-left py-3 px-4">Test 7</td>
       			<td class="w-1/2 text-left py-3 px-4">-</td>
					...
					if($flag==1){
					?>
						<?php echo '<a href="IDP_update.php?user='.$username.'"><button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-2 rounded focus:outline-none focus:shadow-outline" >
							Update
						</button></a>'; ?>						
						<?php
					}else{
						?>
						<a href="IDP_update.php"><button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-2 rounded focus:outline-none focus:shadow-outline" >
							Update
						</button></a>
						<?php
					}
