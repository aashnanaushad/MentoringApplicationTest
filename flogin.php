...
<body class=" bg-blue-400 ">
		...
		<div class="flex items-center flex-shrink-0 text-blue-600 mr-6">
			<span class="font-semibold text-xl tracking-tight">Faculty Login</span>
		</div>
			<div>
		...
		<div class=" px-3 py-10 pt-20 bg-blue-400 flex justify-center">
				<div class=" bg-white shadow-md rounded px-8 pt-8 pb-10 mb-8 " >
					...
					<form action="flogin.php" method="post" class=" bg-white shadow-md rounded px-8 pt-8 pb-10 mb-8 " >
					<div class="mb-4">
