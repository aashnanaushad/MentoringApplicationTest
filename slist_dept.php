...
<div class="table-scrol">  
    <h1 align="center">Students of <?php echo $dept1;?></h1>  
...
<!--here showing results in the table -->  
            ...
            <td><a href="slist_dept.php"><button class="btn btn-danger" type="submit" name="<?php echo $user_id;?>">Delete</button></a></td> <!--btn btn-danger is a bootstrap button to show danger-->  
        </tr>  
        </form>
        <?php
