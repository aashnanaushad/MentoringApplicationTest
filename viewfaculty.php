...
<!--here showing results in the table -->  
            ...
            <td class="p-4 w-1/6 overflow-hidden"><a href="viefaculty.php"><button class="text-red-400" type="submit" name="<?php echo $user_id;?>">Delete</button></a></td> <!--btn btn-danger is a bootstrap button to show danger -->  
        </tr>  
        </form>
        <?php
