...
<html>
	...
	<!-- <div id="main-wrapper">
		...
		<form action="request_counselor.php" method="post">
				...
				<button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" name="request_counselor" type="submit">REQUEST</button>
		</form>
        </div>
	</div> -->
				    ...
				    if($r){
                        ...
                        while($row=mysqli_fetch_assoc($r)){
                             ...
                             if($approve==2){
                                 //chat active
                                 ?>
                                    <a class="inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-800" href="active_chats.php">
